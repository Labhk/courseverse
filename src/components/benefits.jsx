        ...
        <div>
            <div className="p-10 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-5">
                ...
                <div className="rounded overflow-hidden shadow-lg  hover:shadow-2xl">
                    <img className="w-full" src="images/foucessed_1.jpg" alt="Mountain" />
                    <div className="px-6 py-4">
                        <div className="font-semibold text-2xl mb-2">Distraction-free learning</div>
                        <p className="text-gray-700 text-base text-justify italic">
                ...
                <div className="rounded overflow-hidden shadow-lg  hover:shadow-2xl">
                    <img className="w-full" src="images/ai.jpg" alt="River" />
                    <div className="px-6 py-4">
                        <div className="font-semibold text-2xl mb-2">Automate summaries</div>
                        <p className="text-gray-700 text-base text-justify italic">
                ...
                <div className="rounded overflow-hidden shadow-lg  hover:shadow-2xl ">
                    <img className="w-full" src="images/quiz.jpg" alt="Forest" />
                    <div className="px-6 py-4">
                        <div className="font-semibold text-2xl mb-2">Interactive quizzes</div>
                        <p className="text-gray-700 text-base text-justify italic">
                ...
                <div className="rounded overflow-hidden shadow-lg  hover:shadow-2xl">
                    <img className="w-full" src="images/doubtsolving.jpg" alt="Doubt Solving" />
                    <div className="px-6 py-4">
                        <div className="font-semibold text-2xl mb-2">Live doubt solving</div>
                        <p className="text-gray-700 text-base text-justify italic">
